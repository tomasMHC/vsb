...
int main() {
    ...
    cout << "Account 2 rate: " << account1->getInterestRate() << " balance: " << account1->getBalance() << endl;
    cout << "Account  rate: " << account1->getInterestRate() << " balance: " << account1->getBalance() << endl;
