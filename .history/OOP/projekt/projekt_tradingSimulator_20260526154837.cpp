...
void Market::addTrader(Client* t) {
    this->traders[this->tradersCount] = t;
    this->tradersCount += 1;
    t->addMarket(this);
}
...
int main() {
    ...
    Client* tomas = new Client("tomas");
    Client* betka = new Client("betka");

    cout << "Pocet obchodnikov: " << market1->getTradersCount();
